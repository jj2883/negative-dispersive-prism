...
%pulse_duration = 82.97*10^(-15);
%used 3dB points for bandwidth
bandwidth_wavelength = (825 - 795)*10^(-9);
%C is field profile. c = 0.441 for gaussian
bandwidth_frequency = bandwidth_wavelength * 0.441 /(800*10^(-9))^2;

GDD = (1/(4*log(2))) * sqrt( (0.441*pulse_duration/bandwidth_frequency)^2 - (0.441/bandwidth_frequency)^4)
